...
tagsInput.directive('autoComplete', function($document, $timeout, $sce, $q, tagsInputConfig, tiUtil) {
    function SuggestionList(loadFn, options) {
        ...
        getIdProperty = function() {
            return options.tagsInput.trackProperty || options.displayProperty || options.tagsInput.displayProperty;
        };
        ...
        self.load = tiUtil.debounce(function(query, tags) {
            ...
            promise.then(function(items) {
                ...
                items = tiUtil.makeObjectArray(getIdProperty());
    ...
    return {
        ...
        link: function(scope, element, attrs, tagsInputCtrl) {
            ...
            getItem = function(item) {
                return item[options.tagsInput.displayProperty || options.tagsInput.displayProperty];
            };
            ...
            scope.track = function(item) {
                return options.tagsInput.trackProperty ? item[options.tagsInput.trackProperty] : getItem(item);
            };
